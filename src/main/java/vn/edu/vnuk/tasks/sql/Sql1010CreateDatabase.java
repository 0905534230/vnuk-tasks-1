...
public class Sql1010CreateDatabase {
	...
	public Sql1010CreateDatabase(Connection connection) {
		...
		this.sqlQuery = "CREATE DATABASE IF NOT EXISTS vnuk_tasks CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;";
	}
	...
	public void run() throws SQLException {
		...
		try {
	        ...
	        System.out.println("   DB \'vnuk_tasks\' successfully created");
